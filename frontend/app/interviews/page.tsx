...
export default function InterviewsAndEmailsPage() {
  ...
  const displayedApplications = useMemo(() => {
    let filtered = applications.filter(app => !(app.emailDraft?.status === 'SENT' && app.status === 'REJECTED'));
                      ...
                      <td className="p-3">
                        {inv ? (
                          <div>
                            ...
                            {inv.meetingLink && (
                              <a href={inv.meetingLink} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-400 hover:text-blue-300 underline mt-1 flex items-center gap-1">
